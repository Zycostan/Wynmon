...
func _do(doer: Monster, source: Object, game_state: GameState, is_critical: bool, logs: Array[String]):
	...
	var stab_coefficient = Calculations.get_stab_coefficient(doer.type, type)
	...
	var amt = base_damage * type_advantage_coefficient * stab_coefficient * stat_diff_coefficient * crit_coefficient
